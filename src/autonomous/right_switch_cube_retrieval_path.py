...
# ]
# 
# GeneratePath(os.path.dirname(__file__), "right_switch_cube_retrieval", waypoints, settings, True)
#===================================================================================================
...
GenerateTalonMotionProfileArcPath(os.path.dirname(__file__), "right_switch_cube_retrieval", waypoints, settings, True)
