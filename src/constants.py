...
PATHFINDER SETTINGS
"""
PF_SAMPLE_PERIOD_MS = 20
PF_MAX_VELOCITY = 8.0 # 5.0
PF_MAX_ACCELERATION = 10
PF_MAX_JERK = 30 # 15
PF_TURNING_RADIUS_FT = 4.0
...
Y_WALL_TO_SWITCH_FAR = 27 - (82.25 / 12)
